...
Write-Host "[1/6] Checking PHP..." -ForegroundColor Green
try {
    $phpVersion = php -v
...
Write-Host ""
Write-Host "[2/6] Creating .env file..." -ForegroundColor Green
if (Test-Path ".\.env") {
...
Write-Host ""
Write-Host "[3/6] Generating application key..." -ForegroundColor Green
...
Write-Host ""
Write-Host "[4/6] Creating SQLite database..." -ForegroundColor Green
...
Write-Host ""
Write-Host "[5/6] Running migrations..." -ForegroundColor Green
...
Write-Host ""
Write-Host "[6/6] Seeding database with test data..." -ForegroundColor Green
php artisan db:seed
if ($LASTEXITCODE -ne 0) {
